...
#### Multiplayer network
Настроил базу репликации проекта и обучал команду правилам репликации в UnrealEngine.
Дораблотал архитектуру проекта для создания уровней с повышенной нагрузкой сети.
...
#### Multiplayer network
Распредилил сетевую логику по GameMode, GameState, PlayerState и PlayerController.
...
#### Оптимизация
Использовал UnrealInsight для пройфалинга кода и сети.
...
Мобильные гонки по безжорожью с  органическим трафиком в сотни тысяч.
