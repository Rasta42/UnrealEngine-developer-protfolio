...
Проводил конкурентный анализа и поиска подходящих референсов.
Оценивал геймплейные механики и их реализацию для формирования фич и внедрения в проект.
...
#### TechArt
Занимался созданием, настройкой, доработка и оптимизация PBR Materials для окружения, персонажей, визуальных эффектов.
Приемка и подключение анимаций персонажей и оружия.
Оптимизация и доработка AnimBP.
Создание, настройка, доработка и оптимизация систем частиц Niagara для эффектов баффов, стрельбы, взрывов.
